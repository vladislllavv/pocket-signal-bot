...
# Lazy import — библиотека опциональна
_pocketoptionapi = None
def _get_po_api():
    global _pocketoptionapi
    if _pocketoptionapi is None:
        try:
            from pocketoptionapi import PocketOptionAPI as api
            _pocketoptionapi = api
        except ImportError:
            raise ImportError(
                "pocketoptionapi не установлен. "
                "Установи: pip install pocketoptionapi"
            )
    return _pocketoptionapi
