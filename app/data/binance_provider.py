...
# Lazy import для ccxt — устанавливается опционально
_ccxt = None
def _get_ccxt():
    global _ccxt
    if _ccxt is None:
        try:
            import ccxt.async_support as _ccxt_module
            _ccxt = _ccxt_module
        except ImportError:
            raise ImportError("ccxt не установлен. Установи: pip install ccxt")
    return _ccxt
